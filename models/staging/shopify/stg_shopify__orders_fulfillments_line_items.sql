...
shopify_fulfillments_line_items as (
    ...
    from 
        {{ ref('stg_shopify__orders_fulfillments') }} as fulfillments,
        jsonb_array_elements(line_items) as line_item

)

select * from shopify_fulfillments_line_items